...
decodeConfig: { decoders: ['bigEndian', 'littleEndian', 'rle', jpegLS',
'jpegLossless', 'jpeg', 'jpeg2000', 'htJ2K'], usePDFJS: false }

# New decoder loading interface
Decoders expose interface:
```js
